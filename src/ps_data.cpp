...
void setup_ps_data() {
    ...
    add_new_global_var("w1", 0.01, 0.0, 10.0);
    add_new_global_var("w2", 0.01, 0.0, 10.0);
    add_new_global_var("a1", 0.01, 0.0, 10.0);
    add_new_global_var("a2", 0.01, 0.0, 10.0);
    add_new_global_var("f1", 0.01, 0.0, 0.0); // read only member 
    add_new_global_var("f2", 0.01, 0.0, 0.0); // read only 
